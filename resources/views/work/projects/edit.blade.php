            ...
            <x-base.preview-component class="intro-y box">
                <div class="p-5">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-lg font-medium">Edit Project: {{ $project->name }}</h2>
                        <x-base.button
                            variant="outline-secondary"
                            onclick="window.location.href='{{ route('work.projects.show', $project) }}'"
                        >
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12">
                                    ...
                                    <x-base.form-textarea
                                        ...
                                        rows="3"
                                        class="w-full"
                                    >{{ $project->description }}</x-base.form-textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-base.form-select id="manager_id" name="manager_id" class="w-full">
                                        ...
                                        @foreach($employees as $employee)
                                            <option value="{{ $employee->id }}" {{ $project->manager_id == $employee->id ? 'selected' : '' }}>
                                                {{ $employee->name }}
                                            </option>
                                        @endforeach
                                    </x-base.form-select>
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-base.form-textarea
                                        ...
                                        rows="3"
                                        class="w-full"
                                    >{{ $project->objectives }}</x-base.form-textarea>
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-base.form-textarea
                                        ...
                                        rows="3"
                                        class="w-full"
                                    >{{ $project->deliverables }}</x-base.form-textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-base.form-textarea
                                        ...
                                        rows="3"
                                        class="w-full"
                                    >{{ $project->risks }}</x-base.form-textarea>
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-6">
                                    ...
                                    <x-base.form-textarea
                                        ...
                                        rows="3"
                                        class="w-full"
                                    >{{ $project->notes }}</x-base.form-textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#edit-project-form').on('submit', function(e) {
                ...
                const submitBtn = $('#update-project-btn');
                ...
                fetch(`{{ url('work/projects') }}/{{ $project->id }}`, {
                    method: 'POST',
                    headers: {
                ...
                .then(data => {
                    if (data.success) {
                        if (typeof window.showSuccess === 'function') {
                            window.showSuccess(data.message || 'Project updated successfully');
                        }
                        setTimeout(() => {
                            window.location.href = `{{ url('work/projects') }}/{{ $project->id }}`;
                        }, 1500);
                    } else {
                        if (data.errors) {
                            ...
                            window.showError(data.message || 'Failed to update project');
                        }
                    }
                })
                .catch(error => {
                    ...
                    if (typeof window.showError === 'function') {
                        window.showError('An error occurred while updating the project');
                    }
                })
                .finally(() => {
