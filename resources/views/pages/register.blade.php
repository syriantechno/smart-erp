...
@section('head')
    ...
    @push('styles')
        <style>
            ...
            .auth-hero-side {
                position: relative;
                background: url('{{ Vite::asset('resources/images/fakers/preview-3.jpg') }}');
            ...
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input type="text" class="auth-input" name="name" value="{{ old('name') }}" placeholder="Amélie Laurent" required autofocus>
                    </div>

                    <div class="auth-input-group">
                        <label class="auth-input-label">Email</label>
                        <input type="email" class="auth-input" name="email" value="{{ old('email') }}" placeholder="amelielaurent7622@gmail.com" required>
                    </div>
                ...
                <div class="auth-footer">
                    <span>Have any account? <a href="{{ route('login') }}" class="signup-link">Sign in</a></span>
