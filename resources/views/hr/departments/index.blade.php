...
@section('subcontent')
            ...
            <x-base.preview-component class="intro-y box bg-white/80 border border-slate-200/70 shadow-[0_18px_45px_rgba(15,23,42,0.10)]">
                <div class="p-5">
                    ...
                    <div class="flex flex-wrap items-center gap-2 mb-4">
                        ...
                        {{-- Page Length --}}
                        <x-base.form-select id="departments-filter-length" class="w-auto text-sm py-1.5">
                        ...
                        {{-- Reset Button --}}
                        <x-base.tippy as="button" id="departments-filter-reset" type="button" content="Reset filters" class="btn-royal btn-royal--outline btn-royal--sm px-2">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <x-base.tippy content="Add department" placement="bottom">
                                <button
                                    type="button"
    ...
    <form id="departments-export-pdf-form" action="{{ route('hr.departments.export-pdf') }}" method="POST" target="_blank" class="hidden">
        @csrf
    </form>
    <form id="departments-export-excel-form" action="{{ route('hr.departments.export-excel') }}" method="GET" target="_blank" class="hidden"></form>
@endsection
@stack('modals')
