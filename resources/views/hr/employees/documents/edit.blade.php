                    ...
                    <form action="{{ route('hr.employees.documents.update', ['employee' => $employee->id, 'document' => $document->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            ...
                            <div class="col-span-12 md:col-span-3">
                                ...
                                <x-base.form-input id="issue_date" name="issue_date" type="date" class="w-full" value="{{ old('issue_date', $document->issue_date ? $document->issue_date->format('Y-m-d') : '') }}" />
                            </div>

                            <!-- Expiry Date -->
                            <div class="col-span-12 md:col-span-3">
                                <x-base.form-label for="expiry_date">Expiry Date</x-base.form-label>
                                <x-base.form-input id="expiry_date" name="expiry_date" type="date" class="w-full" value="{{ old('expiry_date', $document->expiry_date ? $document->expiry_date->format('Y-m-d') : '') }}" />
                            </div>
