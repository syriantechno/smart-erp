...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.erp.action-button','data' => ['icon' => 'Edit','variant' => 'primary','title' => 'Edit Department','onclick' => 'openDepartmentModal('.e($department->id).')']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'Edit','variant' => 'primary','title' => 'Edit Department','onclick' => 'openDepartmentModal('.e($department->id).')']); ?>
