<?php $__env->startSection('head'); ?>
    <title>Create Account - Smart ERP</title>
    <?php $__env->startPush('styles'); ?>
        <style>
            ...
            .auth-hero-side {
                position: relative;
                background: url('<?php echo e(Vite::asset('resources/images/fakers/preview-3.jpg')); ?>');
    ...
    <div class="auth-container">
        ...
        <div class="auth-form-side">
            <div class="auth-form-wrapper">
                <div class="auth-logo">
                    <img src="<?php echo e(Vite::asset('resources/images/logo.svg')); ?>" alt="<?php echo e(config('app.name')); ?>" class="auth-logo-icon">
                    <span class="auth-logo-text"><?php echo e(config('app.name')); ?></span>
                </div>

                <h1 class="auth-form-title">Create an account</h1>
                <p class="auth-form-subtitle">Sign up and get 30 day free trial</p>
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input type="text" class="auth-input" name="name" value="<?php echo e(old('name')); ?>" placeholder="Amélie Laurent" required autofocus>
                    </div>

                    <div class="auth-input-group">
                        <label class="auth-input-label">Email</label>
                        <input type="email" class="auth-input" name="email" value="<?php echo e(old('email')); ?>" placeholder="amelielaurent7622@gmail.com" required>
                    </div>
                    ...
                    <div class="auth-input-group">
                        ...
                        <input type="password" class="auth-input" name="password_confirmation" placeholder="••••••••••••••••" required>
                    </div>
                ...
                <div class="auth-footer">
                    <span>Have any account? <a href="<?php echo e(route('login')); ?>" class="signup-link">Sign in</a></span>
        ...
        <div class="auth-hero-side">
            ...
            <div class="auth-avatars-group" style="top: 22%; right: 6%;">
                <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-1.jpg')); ?>" class="auth-avatar" alt="Team member">
                <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-2.jpg')); ?>" class="auth-avatar" alt="Team member">
                <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-3.jpg')); ?>" class="auth-avatar" alt="Team member">
            </div>
            ...
            <div class="auth-calendar-card">
                ...
                <div class="auth-meeting-card">
                    ...
                    <div class="auth-meeting-avatars">
                        <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-4.jpg')); ?>" alt="Attendee">
                        <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-5.jpg')); ?>" alt="Attendee">
                        <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-6.jpg')); ?>" alt="Attendee">
                        <img src="<?php echo e(Vite::asset('resources/images/fakers/profile-7.jpg')); ?>" alt="Attendee">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('../themes/base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\smart-erp\resources\views/pages/register.blade.php ENDPATH**/ ?>