...
<div class="flex items-center justify-center gap-1">
    <!-- View Button -->
    <a href="#" onclick="viewShift(<?php echo e($shift->id); ?>)"
...
<?php endif; ?>
    ...
    <?php if($canEdit): ?>
        <button type="button"
                onclick="editShift(<?php echo e($shift->id); ?>)"
...
<?php endif; ?>
    ...
    <button onclick="toggleShiftStatus(<?php echo e($shift->id); ?>)"
            class="flex items-center px-2 py-1 text-xs font-medium <?php echo e($shift->is_active ? 'text-orange-600 hover:text-orange-800 dark:text-orange-400 dark:hover:text-orange-200' : 'text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-200'); ?>"
            title="<?php echo e($shift->is_active ? 'Deactivate' : 'Activate'); ?>">
        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => ''.e($shift->is_active ? 'EyeOff' : 'Eye').'','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => ''.e($shift->is_active ? 'EyeOff' : 'Eye').'','class' => 'w-4 h-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php endif; ?>
    ...
    <!-- Delete Button -->
    <?php if($canDelete): ?>
        <button onclick="deleteShift(<?php echo e($shift->id); ?>, '<?php echo e(addslashes($shift->name)); ?>')"
...
<?php /**PATH E:\ERP System\Source\resources\views/hr/shifts/partials/actions.blade.php ENDPATH**/ ?>