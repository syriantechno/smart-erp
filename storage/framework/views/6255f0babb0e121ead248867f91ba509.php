...
<?php endif; ?>
                                ...
                                <?php if($task->due_date && $task->status !== 'completed'): ?>
                                    <button type="button" 
                                            ...
                                            data-task-id="<?php echo e($task->id); ?>"
                                            data-due-date="<?php echo e($task->due_date->format('Y-m-d')); ?>"
                                            data-has-pending="<?php echo e($task->hasPendingExtensionRequest() ? 'true' : 'false'); ?>">
                                        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('tasks.modals.extension-request', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
