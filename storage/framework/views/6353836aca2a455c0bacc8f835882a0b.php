<?php $__env->startSection('head'); ?>
    ...
    <?php $__env->startPush('styles'); ?>
        <style>
            ...
            .auth-hero-side {
                position: relative;
                background: url('<?php echo e(Vite::asset('resources/images/fakers/preview-2.jpg')); ?>');
            ...
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input type="email" class="auth-input" name="email" value="<?php echo e(old('email')); ?>" placeholder="email@example.com" required autofocus>
                    </div>
                ...
                <div class="auth-footer">
                    <span>Don't have an account? <a href="<?php echo e(route('register')); ?>" class="signup-link">Sign up</a></span>
...
<?php echo $__env->make('../themes/base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laravel\smart-erp\resources\views/pages/login.blade.php ENDPATH**/ ?>