...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('warehouse.material-requests.index')); ?>" class="h-10 rounded-full px-5 flex items-center justify-center text-xs font-semibold text-slate-600 border border-slate-300 hover:bg-white/80 transition-all">
...
<?php endif; ?> View All
            ...
            <a href="<?php echo e(route('warehouse.material-requests.index')); ?>" class="h-10 rounded-full px-5 flex items-center justify-center text-xs font-semibold text-white bg-[#303030] hover:bg-[#404040] transition-all">
                <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php endif; ?>
                ...
                <div>
                    <div class="text-3xl font-bold text-white"><?php echo e($materialRequests->count()); ?></div>
...
<?php endif; ?>
                ...
                <div>
                    <div class="text-3xl font-bold text-white"><?php echo e($approvedCount); ?></div>
...
<?php endif; ?>
                ...
                <div>
                    <div class="text-3xl font-bold text-white"><?php echo e($rejectedCount); ?></div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    <td class="px-6 py-4">
                        <span class="font-mono font-medium text-[#303030]"><?php echo e($request->code); ?></span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm text-slate-700"><?php echo e($request->title ?? 'N/A'); ?></span>
                    </td>
                    <td class="px-6 py-4 text-sm text-slate-600"><?php echo e($request->created_at->format('M d, Y')); ?></td>
                    <td class="px-6 py-4 text-center">
                        <span class="inline-flex px-3 py-1.5 rounded-full text-xs font-semibold
                            <?php if($request->status === 'delivered'): ?> bg-green-100 text-green-700
                            <?php elseif($request->status === 'approved'): ?> bg-blue-100 text-blue-700
                            <?php elseif($request->status === 'pending'): ?> bg-amber-100 text-amber-700
                    ...
                    <td class="px-6 py-4 text-center">
                        <span class="inline-flex px-3 py-1.5 rounded-full text-xs font-semibold
                            <?php if($request->priority === 'urgent' || $request->priority === 'high'): ?> bg-red-100 text-red-700
                            <?php elseif($request->priority === 'medium'): ?> bg-amber-100 text-amber-700
                            <?php else: ?> bg-slate-100 text-slate-600 <?php endif; ?>">
                            <?php echo e(ucfirst($request->priority ?? 'normal')); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 text-right font-medium text-slate-700">$<?php echo e(number_format($request->total_amount ?? 0, 2)); ?></td>
                    <td class="px-6 py-4 text-right">
                        <a href="<?php echo e(route('warehouse.material-requests.show', $request)); ?>" class="inline-flex items-center justify-center h-8 w-8 rounded-full hover:bg-slate-100 text-slate-400 hover:text-[#303030] transition-all">
                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('warehouse.material-requests.index')); ?>" class="inline-flex items-center mt-4 px-5 py-2.5 rounded-full bg-[#303030] text-white text-sm font-semibold hover:bg-[#404040] transition-all">
                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'plus','class' => 'w-4 h-4 mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
...
<?php /**PATH D:\laravel\smart-erp\resources\views/work/projects/partials/show/tab-requests.blade.php ENDPATH**/ ?>