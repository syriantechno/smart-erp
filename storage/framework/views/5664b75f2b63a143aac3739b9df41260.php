                ...
                <div class="p-5">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('manufacturing.orders.create')); ?>" class="btn btn-primary">
            ...
            <div class="intro-y box">
                <div class="p-5">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="<?php echo e(route('manufacturing.orders.index')); ?>" class="text-sm text-blue-600 hover:text-blue-700">View All</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action">
                                        <div class="flex items-center">
                                            <a class="flex items-center mr-3 text-blue-600 hover:text-blue-700" href="<?php echo e(route('manufacturing.orders.show', $order)); ?>">
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\ERP System\Source\resources\views/manufacturing/index.blade.php ENDPATH**/ ?>