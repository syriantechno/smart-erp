...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeJournalEntriesTable() {
        ...
        window.journalEntriesTable = window.erpCrud.initDataTable({
            ...
            ajaxUrl: '<?php echo e(route("accounting.journal-entries.datatable")); ?>',
            pageLength: 10,
            order: [[2, 'desc']],
            columns: [
...
<?php /**PATH D:\laravel\smart-erp\resources\views/accounting/journal-entries/modals/list.blade.php ENDPATH**/ ?>