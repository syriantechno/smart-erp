...
<?php endif; ?>
                    ...
                    <div class="mt-4 text-3xl font-semibold"><?php echo e(number_format($stats['total_companies'])); ?></div>
                </div>
            </div>
            <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                <div class="crm-metric-card">
...
<?php endif; ?>
                    ...
                    <div class="mt-4 text-3xl font-semibold text-emerald-600"><?php echo e(number_format($stats['active_companies'])); ?></div>
                </div>
            </div>
            <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                <div class="crm-metric-card">
...
<?php endif; ?>
                    ...
                    <div class="mt-4 text-3xl font-semibold text-blue-600"><?php echo e(number_format($stats['with_open_opportunities'])); ?></div>
                </div>
            </div>
            <div class="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
                <div class="crm-metric-card">
...
<?php endif; ?>
                    ...
                    <div class="mt-4 text-3xl font-semibold text-indigo-600"><?php echo e(number_format($stats['with_recent_activity'])); ?></div>
                </div>
            </div>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-select.index','data' => ['id' => 'crm-company-status','class' => 'crm-filter-pill']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'crm-company-status','class' => 'crm-filter-pill']); ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col gap-2 lg:flex-row lg:items-center">
                    ...
                    <?php if (isset($component)) { $__componentOriginal1c0beb3cd2271cd34645d22f15db5e3a = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1c0beb3cd2271cd34645d22f15db5e3a = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-select.index','data' => ['id' => 'crm-company-industry','class' => 'crm-filter-pill']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.form-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'crm-company-industry','class' => 'crm-filter-pill']); ?>
                        <option value="all">All</option>
...
<?php endif; ?> Reset
    ...
    <?php echo $__env->make('crm.companies.partials.create-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const table = $('#crm-companies-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(route('crm.companies.datatable')); ?>',
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\ERP System\Source\resources\views/crm/companies/index.blade.php ENDPATH**/ ?>