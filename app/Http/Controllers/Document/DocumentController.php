...
class DocumentController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return Reply::success('Document uploaded successfully', [
                'document' => $document,
            ]);

        } catch (\Exception $e) {
            DB::rollBack();
            return Reply::error('Failed to upload document: ' . $e->getMessage(), [], 500);
        }
    }
    ...
    public function update(Request $request, Document $document): JsonResponse
    {
        ...
        try {
            ...
            return Reply::success('Document updated successfully', [
                'document' => $document,
            ]);

        } catch (\Exception $e) {
            return Reply::error('Failed to update document: ' . $e->getMessage(), [], 500);
        }
    }
    ...
    public function destroy(Document $document): JsonResponse
    {
        ...
        try {
            ...
            return Reply::success('Document deleted successfully');

        } catch (\Exception $e) {
            return Reply::error('Failed to delete document: ' . $e->getMessage(), [], 500);
        }
    }
    ...
    public function storeCategory(Request $request): JsonResponse
    {
        ...
        try {
            ...
            return Reply::error('Failed to create category: ' . $e->getMessage(), [], 500);
        }
    }
    ...
    public function updateCategory(Request $request, DocumentCategory $category): JsonResponse
    {
        ...
        try {
            ...
            return Reply::error('Failed to update category: ' . $e->getMessage(), [], 500);
        }
    }
    ...
    public function destroyCategory(DocumentCategory $category): JsonResponse
    {
        ...
        if ($category->documents()->count() > 0) {
            return Reply::error('Cannot delete category with documents. Move or delete documents first.', [], 400);
        }
        ...
        try {
            ...
            return Reply::error('Failed to delete category: ' . $e->getMessage(), [], 500);
        }
    }
